  ...
  return (
    <div className="flex flex-col w-full h-full">
      <div className="h-[100px] flex w-full bg-green-400 justify-between">
        <span className="bg-black  text-white flex justify-center items-center h-full text-center">
          {translate("TITLE.TEST")}
        </span>
        <span className="bg-black flex text-white justify-center items-center h-full text-center">
          {translate("TITLE.TEST2")}
        </span>
